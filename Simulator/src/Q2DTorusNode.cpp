...
// { // share buffers are used first,when no share buffers ,

// 	if (R1 == chn)
// 	{ //	the separate buffers are used.So first we check the
...
// 	if (linkxneg != -1)
// 		bufferxneglink = (*torus)[linkxneg]->bufferxpos;
// 	else
// 		bufferxneglink = NULL;
// 	if (linkxpos != -1)
// 		bufferxposlink = (*torus)[linkxpos]->bufferxneg;
// 	else
// 		bufferxposlink = NULL;

// 	if (linkyneg != -1)
// 		bufferyneglink = (*torus)[linkyneg]->bufferypos;
// 	else
// 		bufferyneglink = NULL;
// 	if (linkypos != -1)
// 		bufferyposlink = (*torus)[linkypos]->bufferyneg;
// 	else
// 		bufferyposlink = NULL;
// }
